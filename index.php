	...
	<div class="banner">
		<div class="banner-text">
			<div class="container">
				...
				<p>Sekolah Menengah Kejujuran dengan berbagai jurusan yang dapat Anda pilih sesuai minat dan bakat Anda.</p>
			</div>
		</div>
	</div>
	...
	<!-- bagian informasi -->
		...
		<div class="container text-center">
			...
			<?php 
				$informasi = mysqli_query($conn, "SELECT * FROM informasi ORDER BY id DESC LIMIT 10");
